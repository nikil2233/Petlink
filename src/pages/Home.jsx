        ...
        <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <motion.div 
                    ...
                    className="text-left"
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-rose-50 text-rose-600 rounded-full text-xs font-bold uppercase tracking-wider mb-6 border border-rose-100">
                        <Heart size={12} fill="currentColor" /> Welcome into the family
                    </div>
                    
                    <h1 className="text-5xl md:text-7xl font-black text-slate-800 mb-6 leading-tight tracking-tight">
                        Give Them a <br/>
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-amber-500">Home.</span>
                    </h1>
                    
                    <p className="text-lg text-slate-500 mb-8 leading-relaxed max-w-md font-medium">
                        Connect with rescuers, adopt loving pets, and find vet care in one beautiful place. Join the movement today.
                    </p>

                    <div className="flex flex-wrap items-center gap-4">
                        <Link to="/notify" className="bg-rose-600 text-white px-[24px] py-[12px] rounded-[12px] font-bold text-sm shadow-lg shadow-rose-200 hover:bg-rose-700 transition-all flex items-center gap-2">
                            <Bell size={18} /> Notify Rescuer
                        </Link>
                        <Link to="/adopt" className="bg-white text-slate-700 border border-slate-200 px-[24px] py-[12px] rounded-[12px] font-bold text-sm hover:bg-slate-50 transition-all flex items-center gap-2">
                    ...
                    <div className="mt-12 flex items-center gap-8">
                        <div>
                            <p className="text-3xl font-black text-slate-800">200+</p>
                        ...
                        <div className="w-px h-10 bg-slate-200"></div>
                        <div>
                            <p className="text-3xl font-black text-slate-800">1k+</p>
                ...
                >
                    <div className="absolute inset-0 bg-gradient-to-tr from-rose-100 to-amber-100 rounded-[32px] transform rotate-3 scale-95 blur-2xl opacity-60"></div>
                    <img 
                        src="https://images.unsplash.com/photo-1548199973-03cce0bbc87b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80" 
                        alt="Happy Dog" 
                        className="relative z-10 w-full rounded-[32px] shadow-2xl object-cover h-[500px]"
                    />
                    ...
                    <motion.div 
                        ...
                        className="absolute bottom-10 -left-10 z-20 bg-white p-4 rounded-[20px] shadow-xl border border-slate-100 flex items-center gap-4"
                    >
                        <div className="bg-emerald-100 p-3 rounded-full text-emerald-600">
                            <Shield size={24} />
                        </div>
                        <div>
                            <p className="text-sm font-bold text-slate-800">Verified Vets</p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
                <h2 className="text-3xl font-black text-slate-800 mb-4">How You Can Help</h2>
...
function FeatureCard({ icon, title, description, link, action, color }) {
    return (
        <Link to={link} className="group bg-white p-8 rounded-[24px] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all">
